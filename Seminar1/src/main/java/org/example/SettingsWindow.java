...
public class SettingsWindow extends JFrame{
    ...
    JLabel gameMode = new JLabel("Выбери режим игры");
    JLabel gameField = new JLabel("Установленный размер поля: ");
    JLabel winCount = new JLabel("Установленная победную длина: ");
    ...
    SettingsWindow(GameWindow gameWindow){
        ...
        winLengthSlider.addChangeListener(new ChangeListener() {
            @Override
            public void stateChanged(ChangeEvent e) {
                winCount.setText("Установленная победная длина: " + winLengthSlider.getValue());
            }
        });
